                    ...
                    <tr style="margin-top: 24px;">
                        <td style="height: 90px;">
                            <div style="text-align: center; width:330px; margin-top: 30px">
                                ...
                                <p style="font-size: 11px;"><?php echo e(date('Y-m-d')); ?></p>
                            </div>
                        </td>
...
<?php echo $__env->make('forthebuilder::layouts.forthebuilder', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\NewOSPanel\domains\ikcrm_release\Modules/ForTheBuilder\Resources/views/house-flat/print.blade.php ENDPATH**/ ?>
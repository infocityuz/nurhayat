...
<?php $__env->startSection('content'); ?>
            ...
            <div class="container-fluid mb-3">
                <div class="row m-0 align-items-center">
                    ...
                    <div class="col-8 py-4">
                        <h2 class="m-0 panelUprText profileTextProfile"><?php echo e(translate('Profile')); ?></h2>
                    </div>
                    <div class="col-4">
                        <div class="ml-auto" id="CurrentDayToday">
                            <?php echo e(translate('Date')); ?>: 
                            <input type="text" class="ml-2 form-control daterange" value="<?php echo e(date('01.m.Y').' - '.date('t.m.Y')); ?>">
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-sm-7">
                        <div class="profileData p-2">
                                ...
                                <?php if(isset($model->id)): ?>
                                    ...
                                    <?php if(file_exists($sms_avatar)): ?>
                                        <img class="profileImageData mr-3"
                                             ...
                                             alt="">
                                    <?php else: ?>
                                        <img class="profileImageData mr-3" src="<?php echo e(asset('/backend-assets/img/not_user.png')); ?>" alt="">
                                    <?php endif; ?>
                                <?php else: ?>
                                    <img class="profileImageData mr-3" src="<?php echo e(asset('/backend-assets/img/not_user.png')); ?>" alt="">
                                <?php endif; ?>
                            ...
                            <div class="h-100 d-flex flex-column justify-content-center">
                                <h3 class="profileNameData"><?php echo e($model->first_name.' '); ?> <?php echo e($model->last_name.' '); ?> <?php echo e($model->middle_name); ?></h3>
                                <p class="profileOtherData"><?php echo e($model->role->name); ?></p>
                                <?php
                                ...
                                <?php if(isset($year_old)): ?>
                                    <p class="profileOtherData"><?php echo e($year_old.' '.translate('years old')); ?></p>
                                <?php else: ?>
                            ...
                            <div class="ml-auto h-100 d-flex flex-column justify-content-end align-items-end">
                                <?php if(isset($model->phone_number)): ?>
                                    <p class="profileOtherData mt-0 mb-2"><?php echo e('+998 '.$model->phone_number); ?></p>
                                <?php else: ?>
                                    <p class="profileOtherData mt-0 mb-2">4234234234244</p>
                                <?php endif; ?>
                                <p class="profileOtherData mt-0 mb-2"><?php echo e($model->email); ?></p>
                                <div class="buttonProfileEditBlue">
                                    <a href="<?php echo e(route('forthebuilder.user.edit',$model->id)); ?>">
                                        <img src="<?php echo e(asset('/backend-assets/forthebuilders/images/edit.png')); ?>" alt="Edit">
                                    </a>
                                </div>
                            </div>
                        </div>    
                    ...
                    <div class="col-sm-5">
                        <div class="chartGreenMoyiZadachi">
                            <h5 class="MoyiZadachiTextCartGreenH5"><?php echo e(translate('Tasks')); ?></h5>
                            <div class="d-flex">
                    ...
                    <div class="col-sm-12">
                        <div class="d-flex">
                            <?php if($user->id == $model->id): ?>
                                <h2 class="panelUprText m-0 mb-2"><?php echo e(translate('My stats')); ?></h2>
                            <?php else: ?>
                                <h2 class="panelUprText m-0 mb-2"><?php echo e(translate('Stats')); ?></h2>
                            <?php endif; ?>
                        </div>            
                    </div>
    ...
    <script>
        ...
        var conn = new WebSocket('ws://127.0.0.1:1235/?token=<?php echo e(auth()->user()->token); ?>');
        // http://127.0.0.1/
            ...
            if(data.response_connected_chat_user)
            {
                ...
                if(data.data.length > 0)
                {
                    for(var count = 0; count < data.data.length; count++)
                    {
                        ...
                        {
                            user_image = `<img src="<?php echo e(asset('/backend-assets/img/not_user.png')); ?>" width="35" class="rounded-circle mr-3" />`;
                            // <?php echo e(asset('uploads/user/'.$model->id.'/s_'.$model->avatar)); ?>

                           
                        }
                        else
                        {
                            user_image = `<img src="<?php echo e(asset('uploads/user/')); ?>/`+data.data[count].id+`/s_`+data.data[count].user_image+`" width="35" class="rounded-circle mr-3" />`;
                            // user_image = `<img src="<?php echo e(asset('images/no-image.jpg')); ?>" width="35" class="rounded-circle mr-3" />`;
                        }
            ...
            if(data.message)
            {
                ...
                if(data.from_user_id == from_user_id)
                {
                    ...
                    if(data.sender_connection[0].avatar== null)
                    {
                        ...
                        user_image = `<img src="<?php echo e(asset('uploads/user/')); ?>/`+data.from_user_id+`/s_`+data.sender_connection[0].avatar+`" width="35" class="rounded-circle mr-3" />`
                    }
                ...
                for(var count = 0; count < data.chat_history.length; count++)
                {
                    if(data.chat_history[count].user_from_id == from_user_id)
                    {
                        ...
                        if(data.sender_connection.avatar== null)
                        {
                            ...
                            user_image = `<img src="<?php echo e(asset('uploads/user/')); ?>/`+data.chat_history[count].user_from_id+`/s_`+data.sender_connection.avatar+`" width="35" class="rounded-circle mr-3" />`
                        }
                    ...
                    else
                    {
                        ...
                        if(data.receiver_connection.avatar== null)
                        {
                            ...
                            user_image = `<img src="<?php echo e(asset('uploads/user/')); ?>/`+data.chat_history[count].user_from_id+`/s_`+data.receiver_connection.avatar+`" width="35" class="rounded-circle mr-3" />`
                        }
                        html += `
                        &nbsp; `+user_image+`
                                    </div>
            ...
            if(data.group_message)
            {
                ...
                if(data.from_user_id == from_user_id)
                {
                    ...
                    if(data.sender_connection.avatar== null)
                    {
                        ...
                        user_image = `<img src="<?php echo e(asset('uploads/user/')); ?>/`+data.from_user_id+`/s_`+data.sender_connection.avatar+`" width="35" class="rounded-circle mr-3" />`
                    }
                ...
                for(var count = 0; count < data.group_chat_history.length; count++)
                {
                    ...
                    if(data.group_chat_history[count].user_from_id == from_user_id)
                    {
                        ...
                        if(data.group_chat_history[count].avatar== null)
                        {
                            ...
                            user_image = `<img src="<?php echo e(asset('uploads/user/')); ?>/`+data.group_chat_history[count].user_from_id+`/s_`+data.group_chat_history[count].avatar+`" width="35" class="rounded-circle mr-3" />`
                        }
...
<?php echo $__env->make('forthebuilder::layouts.forthebuilder', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/user/Desktop/laravel/ikcrm_release/Modules/ForTheBuilder/Resources/views/user/show.blade.php ENDPATH**/ ?>
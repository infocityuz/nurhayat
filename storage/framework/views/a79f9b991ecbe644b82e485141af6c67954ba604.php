                        ...
                        <div class="jkMiniData mt-1 hideData" >
                            ...
                            <div class="jkMiniData" >
                                ...
                                <div class="checkboxDivTextInput4 deystvieJkHome">
                                    ...
                                    <a href="<?php echo e(route('forthebuilder.house.edit', $model->id)); ?>"
                                        class="seaDiv">
                                            <img style="margin-top: 4px;" width="25" height="25"
...
<?php echo $__env->make('forthebuilder::layouts.forthebuilder', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nurhayat.icstroy.uz/public_html/Modules/ForTheBuilder/Resources/views/house/index.blade.php ENDPATH**/ ?>
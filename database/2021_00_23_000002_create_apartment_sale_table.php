...
class CreateApartmentSaleTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('apartment_sale', function (Blueprint $table) {
            $table->id();
            ...
            $table->decimal('ceiling_height',10,2);
            ...
            $table->integer('is_parser')->nullable();
            $table->softDeletes();
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('apartment_sale');
    }
}

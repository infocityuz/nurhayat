...
class ParsingRentCommand extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'parsing:rent';
    ...
    {
        $ch = curl_init();
        curl_setopt($ch, CURLOPT_URL, "https://www.olx.uz/d/nedvizhimost/kvartiry/arenda-dolgosrochnaya/");

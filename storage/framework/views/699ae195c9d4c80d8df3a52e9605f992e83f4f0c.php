                            ...
                            <div style="width: auto;" class="jkMiniData mb-1 hideData">
                                ...
                                <div class='d-flex'>
                                    ...
                                    <a style="width: 9.3vw;" href="<?php echo e(route('forthebuilder.installment-plan.show', $model->id)); ?>" class="rassrochkaPokazatStatusGreen show-status" data-id="<?php echo e($model->id); ?>"
                                        data-period="<?php echo e((($model->installmentPlan) ?  $model->installmentPlan->period : '')); ?>"
...
<?php echo $__env->make('forthebuilder::layouts.forthebuilder', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/user/Desktop/laravel/ikcrm_release/Modules/ForTheBuilder/Resources/views/installment-plan/index.blade.php ENDPATH**/ ?>
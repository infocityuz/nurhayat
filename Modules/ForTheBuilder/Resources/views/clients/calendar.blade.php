                    ...
                    <div class="sticky-top mb-3">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">{{translate('Draggable Events')}}</h4>
                            </div>
                            <div class="card-body">
                                <!-- the events -->
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">{{translate('Create Event')}}</h3>
                            </div>
                            <div class="card-body">
                                ...
                                <div class="input-group">
                                    ...
                                    <div class="input-group-append">
                                        <button id="add-new-event" type="button" class="btn btn-primary">{{translate('Add')}}</button>
                                    </div>
                                    <!-- /btn-group -->
                                </div>
                                <!-- /input-group -->

...
@section('title') Street @endsection
@section('styles')
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">{{__('locale.street')}}</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="create-data" style="float: right;">
                            <a href="{{route('street.create', app()->getLocale())}}" class=" style-add btn btn-primary">{{__('locale.create')}}</a>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div style="text-align: center;">
                                        <a href="{{route('district.show',[app()->getLocale(), $model->id])}}" class="btn btn-primary" title="show"><i class="fas fa-eye"></i></a>
                                        <a href="{{route('district.edit',[app()->getLocale(), $model->id])}}" class="btn btn-primary" title="update"><i class="fas fa-pencil-alt"></i></a>
                                        <form style="display: inline-block;" action="{{route('district.destroy',[app()->getLocale(), $model->id])}}" method="POST">
                                            @csrf
                                            @method('DELETE')

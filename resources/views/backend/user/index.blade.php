                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="create-data" style="float: right;">
                            <a href="{{route('user.create', app()->getLocale())}}" class=" style-add btn btn-primary">{{__('locale.create')}}</a>
                        </div>
                    ...
                    @if(!empty($models))
                        @foreach($models as $key => $model)
                            <tr>
                                ...
                                <td>{{$model->email}}</td>
                                <td>
                                    <img src="{{ asset('/uploads/user/'.$model->id.'/s_'.$model->avatar)}}" class="img-fluid mb-2" alt="" style="width: 100px; height: 100px">
                                </td>
                                <td>
                                    <div style="text-align: center;">
                                        <a href="{{route('user.show', ['language'=>app()->getLocale(), $model->id])}}" class="btn btn-primary" title="show"><i class="fas fa-eye"></i></a>
                                        <a href="{{route('user.edit', ['language'=>app()->getLocale(), $model->id])}}" class="btn btn-primary" title="update"><i class="fas fa-pencil-alt"></i></a>
                                        <form style="display: inline-block;" action="{{route('user.destroy', ['language'=>app()->getLocale(), $model->id])}}" method="POST">
                                            @csrf
                                            @method('DELETE')

...
@section('content')
    ...
    @endif
    <form action="{{route('apartment-sale.store', app()->getLocale())}}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-md-8">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="distance_to_metro" class="form-control" step="0.01" min="0"  id="distanceToMetro" list="browsers">
                                            </div>
                                            <input type="hidden" id="hidden_name" name="hidden_name">
                                        </div>
                                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <select required name="repair" id="repair"
                        ...
                        <div class="form-group">
                            ...
                            <textarea type="text" name="description"
                                      id="descriptionId"
                                      class="form-control @error('description') error-data-input is-invalid @enderror" required style="height: 100px">{{ old('description') }}</textarea>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-lg-6">
                                <div class="form-group">
                                    ...
                                    <a type="button" class="metro_status_value fa fa-angle-down" id="metroId">
                ...
                <div class="card card-primary">
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="number" name="floor" id="floor_id" class="form-control @error('floor') error-data-input is-invalid @enderror" value="{{ old('floor') }}" required>
                            <span class="error-data">@error('floor'){{$message}}@enderror</span>
                        </div>
                        <div class="form-group">
                            <label for="floors_of_houseId">{{__('locale.floors_of_house')}}</label>
                            <input type="number" name="floors_of_house" id="floors_of_houseId" class="form-control @error('floors_of_house') error-data-input is-invalid @enderror" value="{{ old('floors_of_house') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" step=0.01 name="kitchen_area" id="kitchen_area_id" class="form-control @error('kitchen_area') error-data-input is-invalid @enderror" value="{{ old('kitchen_area') }}" required>
                            <span class="error-data">@error('kitchen_area'){{$message}}@enderror</span>
                        </div>
                        <div class="form-group">
                            <label for="living_space_id">{{__('locale.living_space')}}</label>
                            <input type="number" step=0.01 name="living_space" id="living_space_id" class="form-control @error('living_space') error-data-input is-invalid @enderror" value="{{ old('living_space') }}" required>
                            <span class="error-data">@error('living_space'){{$message}}@enderror</span>
                        </div>
                        <div class="form-group">
                            <label for="total_areaId">{{__('locale.total_area')}}</label>
                            <input type="number" step=0.01 name="total_area" id="total_areaId" class="form-control @error('total_area') error-data-input is-invalid @enderror" value="{{ old('total_area') }}" required>
                            <span class="error-data">@error('total_area'){{$message}}@enderror</span>
                        </div>
                        <div class="form-group">
                            <label for="number_of_rooms_id">{{__('locale.number_of_rooms')}}</label>
                            <input type="number" name="number_of_rooms" id="number_of_rooms_id" class="form-control @error('number_of_rooms') error-data-input is-invalid @enderror" value="{{ old('number_of_rooms') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" step=0.01 name="ceiling_height" id="ceiling_heightId" class="form-control @error('ceiling_height') error-data-input is-invalid @enderror" value="{{ old('ceiling_height') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <div class="custom-control custom-radio d-flex">
                                <div style="margin-right: 50px">
                                    <input class="custom-control-input" name="currency" type="radio" checked id="uzsId" value="2">
                                    <label for="uzsId" class="custom-control-label">{{__('locale.uzs')}}</label>
                                    <span class="error-data">@error('currency'){{$message}}@enderror</span>
                                </div>
                                <div>
                                    <input class="custom-control-input" type="radio" name="currency" id="usdId" value="1">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="price" step=0.01 id="priceId" class="form-control @error('price') error-data-input is-invalid @enderror" value="{{ old('price') }}" required>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div>
                            {{-- <form action="{{route('real-estate.apartment-sale.file-delete-all')}}">
                                @csrf
                                @method('DELETE') --}}
                            <a class="btn btn-info" id="delete-all-kartik-fileinput">{{__('locale.delete')}}</a>
                            {{-- </form> --}}
                        </div>
                    </div>
                </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#images").fileinput({
                ...
                // deleteUrl: "/real-estate/apartment-sale/file-delete-all",
                // ajaxDeleteSettings: {
                //     type: 'post', // This should override the ajax as $.ajax({ type: 'DELETE' })
                //     url: "/real-estate/apartment-sale/file-delete-all"
                // },
                allowedFileExtensions: ['png','jpg','jpeg','svg','PNG','JPG','JPEG','SVG'],
                uploadAsync: false,
                maxFileSize: 150000,
                maxFilesNum: 25,
                showUpload: false,
                ...
                initialPreview: [
                    @if(!empty($files_saved))
                        ...
                        "{{asset('/uploads/tmp_files/' . Auth::user()->id.'/apartment-sale/'.$files_savedItem->getFilename())}}",
                    @endforeach
                    @endif
                ],
                initialPreviewConfig: [
                        @if(!empty($files_saved))
                        @foreach($files_saved as $files_savedItem)
                        @if($files_savedItem->getExtension() == 'jpg' || $files_savedItem->getExtension() == 'JPG' || $files_savedItem->getExtension() == 'jpeg' || $files_savedItem->getExtension() == 'JPEG' || $files_savedItem->getExtension() == 'png' || $files_savedItem->getExtension() == 'PNG')
                    {caption: "{{$files_savedItem->getFilename()}}", size: "{{$files_savedItem->getSize()}}", width: "120px", url: `/${current_language}/apartment-sale/file-delete/`+'{{$files_savedItem->getFilename()}}', key: "{{$files_savedItem->getFilename()}}"},
                        @else
                    {type: "{{$files_savedItem->getExtension()}}",caption: "{{$files_savedItem->getFilename()}}", size: "{{$files_savedItem->getSize()}}", width: "120px", url: `/${current_language}/apartment-sale/file-delete/`+'{{$files_savedItem->getFilename()}}', key: "{{$files_savedItem->getFilename()}}"},
                    @endif
                    @endforeach
                    @endif
                ]
                ...
                // console.log('e : ' , e)
                // var params = params.stack;
                var datastack = params.stack;
                var dataOldIndex = params.oldIndex;
                var dataNewIndex = params.newIndex;
                $.ajax({
                    url: `/${current_language}/real-estate/apartment-sale/file-sort`,
                    type: 'post',
                    ...
                    success: function (data) {
                        ...
                        // $.each(data['images'], function (indexInArray, valueOfElement) {
                        //     // $('.file-preview-frame').data('fileindex').find('.file-caption-info').text
                        //     // data-fileindex $('#thumb-images-init-' .file-caption-info').text(valueOfElement.caption);
                        //     console.log(indexInArray, valueOfElement);
                        //     // console.log(indexInArray,valueOfElement.caption);
                        //     // let dfileindex = $('.file-preview-frame').data('fileindex')
                        //     $(`div[data-fileindex=init-${indexInArray}] .file-caption-info`).text(valueOfElement)
                        //     // console.log($('div[data-fileindex=init-'+indexInArray+'] .file-caption-info'));
                        // });
                        //    console.log( $('.file-caption-info'));
            ...
            $('#delete-all-kartik-fileinput').on('click',function (e) {
                // e.preventDefault();
                $.ajax({
                    url: `/${current_language}/real-estate/apartment-sale/file-delete-all`,
                    type: 'POST',
                    data: {
                        _method: 'DELETE'
                    },
                    ...
                    success: function (data) {
                        ...
                        // console.log(data['success'])
                        // location.reload();
                        $('.file-preview-thumbnails div').remove();
        ...
        let mapOptions = {
            center:[41.32508826970849, 69.32866686970848],
            zoom:16
        };
        let mapGoogleOptions = {
            center: {lat:41.32508826970849, lng:69.32866686970848},
            zoom: 16,

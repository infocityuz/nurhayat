...
<?php $__env->startSection('content'); ?>
    <div class="d-flex aad">
        ...
        <div class="mainMargin">
            ...
            <div class="d-flex justify-content-between" style="width: 992px;">
                <div class="d-flex">
                    <h2 class="panelUprText profileTextProfile"><?php echo e(translate('Profile')); ?></h2>
                </div>
            </div>

            <div class="d-flex profileMax1920" style="margin-bottom: 100%;">
                <div>
                    ...
                    <div class="d-flex">
                        <?php if($user->id == $model->id): ?>
                            <h2 class="panelUprText"><?php echo e(translate('My stats')); ?></h2>
                        <?php else: ?>
                            <h2 class="panelUprText"><?php echo e(translate('Stats')); ?></h2>
                        <?php endif; ?>
                    </div>
    ...
    <script>
        ...
        var conn = new WebSocket('ws://127.0.0.1:30000/?token=<?php echo e(auth()->user()->token); ?>');
        // http://127.0.0.1/
...
<?php echo $__env->make('forthebuilder::layouts.forthebuilder', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\NewOSPanel\domains\ikcrm_release\Modules/ForTheBuilder\Resources/views/user/show.blade.php ENDPATH**/ ?>
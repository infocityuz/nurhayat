                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="ml-auto" id="CurrentDayToday">
                            ...
                            <input type="text" class="ml-2 form-control daterange2" value="<?php echo e(date('d.m.Y', strtotime($data['start'])).' - '.date('d.m.Y', strtotime($data['end']))); ?>">
                        </div>        
                    </div>
                </div>
...
<?php echo $__env->make('forthebuilder::layouts.forthebuilder', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/user/Desktop/laravel/ikcrm_release/Modules/ForTheBuilder/Resources/views/filtr.blade.php ENDPATH**/ ?>
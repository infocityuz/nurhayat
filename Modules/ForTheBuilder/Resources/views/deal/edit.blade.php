...
@section('content')
    <div class="d-flex aad">
        ...
        <div class="mainMargin">
            ...
            <div class="sozdatJkData">
                <form id="deal-create-form" action="{{route('forthebuilder.deal.update',$model->id)}}" method="POST"
                    ...
                    <div class="d-flex justify-content-between">
                        <div>
                            ...
                            <div class="sozdatImyaSpsok">
                                ...
                                @if($clients != 'NULL')
                                    <input class="sozdatImyaSpisokInputProdnoBig keyUpName booking-series_number form-control @error('series_number') error-data-input is-invalid @enderror"
                                        type="text" name="series_number" id="series_number" value="{{ $clients->informations->series_number??'', old('series_number') }}">
                                @else
                                    <input class="sozdatImyaSpisokInputProdnoBig keyUpName booking-series_number form-control @error('series_number') error-data-input is-invalid @enderror"
                                           type="text" name="series_number" id="series_number" value="{{ old('series_number') }}">
                                @endif
                                    <div class="keyUpNameResult d-none"
                                     style="width: 65%; background: lightgrey; max-height: 220px; position: absolute; margin-top: 75px; overflow: scroll; border-radius: 15px;">
                                </div>
                            ...
                            <div class="sozdatImyaSpsok">
                                ...
                                @if($clients != 'NULL')
                                    <input class="sozdatImyaSpisokInputProdnoBig booking-given_date form-control @error('given_date') error-data-input is-invalid @enderror"
                                           value="{{ $clients->informations->given_date??'', old('given_date') }}" type="date" name="given_date" id="given_date">
                                @else
                                    <input class="sozdatImyaSpisokInputProdnoBig booking-given_date form-control @error('given_date') error-data-input is-invalid @enderror"
                            ...
                            <div class="sozdatImyaSpsok">
                                ...
                                @if($clients != 'NULL')
                                    <input class="sozdatImyaSpisokInputProdnoBig booking-issued_by form-control @error('live_address') error-data-input is-invalid @enderror"
                                           value="{{$clients->informations->live_address??'', old('live_address') }}" type="text" name="live_address"
                                           id="live_address">
                                @else
                                    <input class="sozdatImyaSpisokInputProdnoBig booking-issued_by form-control @error('live_address') error-data-input is-invalid @enderror"
                            ...
                            <div class="sozdatImyaSpsok">
                                ...
                                @if($clients != 'NULL')
                                    <input class="sozdatImyaSpisokInputProdnoBig booking-inn @error('inn') error-data-input is-invalid @enderror"
                                           value="{{ $clients->informations->inn??'', old('inn') }}" type="text" name="inn" id="inn">
                                @else
                                    <input class="sozdatImyaSpisokInputProdnoBig booking-inn @error('inn') error-data-input is-invalid @enderror"
                                           value="{{ $clients->informations->inn??'', old('inn') }}" type="text" name="inn" id="inn">
                                @endif
                            ...
                            <div class="sozdatImyaSpsok">
                                ...
                                <div class="d-flex">
                                    ...
                                    <div>
                                        <input class="form-control keyUpName booking-phone @error('phone') error-data-input is-invalid @enderror"
                                               type="tel" id="phone" name="phone_number"
                                               value="{{ $clients != 'NULL'?$clients->phone:'', old('phone_number') }}" required>
                            ...
                            <div class="sozdatImyaSpsok">
                                ...
                                <div class="d-flex">
                                    ...
                                    <div>
                                        <input class="form-control keyUpName booking-additional_phone @error('additional_phone') error-data-input is-invalid @enderror"
                        ...
                        <div class="d-flex prodnoRightImportData" style="margin-top: 40px;">
                                    ...
                                    <div class="rassrochkaProdnoCheckBox7">
                                        <label class="d-flex flexDropdownRassrochka mt-1">
                                            <input class="rassrochkaProdnoCheck mt-2" type="checkbox"
                                                   name="is_installment" id="is_installment"> {{ translate('Installment plan') }}
                                        </label>
                                        <label class="d-flex flexDropdownRassrochka mt-1">
                                              <span class="error-data">
                                        ...
                                        <div id="noneDownDrop" class="noneDropDown">
                                                ...
                                                <select class="form-control sozdatImyaSpisokDropDown selectPeriod"
                                                    ...
                                                    @if(isset($installmentPlan))
                                                        @foreach ($installmentPlan as $val)
                                                            @if($val->period > 0)  
                                                                <option value="{{ $val->id }}" {{$model->installment_plan_id == $val->id?"selected":''}}
                                            ...
                                            <div class="polniy_DropDown">
                                                ...
                                                <select class="form-control sozdatImyaSpisokDropDown selectPercent"
                                                    ...
                                                    @if(isset($installmentPlan))
                                                        @foreach ($installmentPlan as $val)
                                                            <option value="{{ $val->id }}" data-percent="{{ $val->percent_type }}"
                                                                    {{$model->installment_plan_id == $val->id ?"selected":''}}>
                                                                {{ $val->percent_type }} %
                                                            </option>
                                                        @endforeach
                                                    @endif
                                            ...
                                            <div class="polniy_DropDown">
                                                ...
                                                <input class="form-control sozdatImyaSpisokDropDown initialFeeDeal"
                                                       type="text" name="initial_fee" value="{{$model->initial_fee??old('initial_fee')}}">
                                                <span class="error-data">
                                                    @error('initial_fee')
                                                    {{ $message }}
                                                    @enderror
                                            ...
                                            <div class="polniy_DropDown">
                                                ...
                                                <input id="dateInput3" class="form-control sozdatImyaSpisokDropDown"
                                                       type="date" name="installment_date" value="{{$initial_fee_date[0]??old('initial_fee_date')}}">
                                                <span class="error-data">
                            ...
                            <div class="displayNoneProdno">
                                ...
                                <div class="form-group">
                                    <h3 class="sozdatImyaSpisokH3Prodno">{{ translate('Date') }}</h3>
                                    <input id="dateInput" placeholder="{{ date('d.m.Y') }}" type="text"
    ...
    <script>
        ...
        let installment_plan_id = "{{$model->installment_plan_id??"NULL"}}"

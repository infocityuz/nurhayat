   ...
   /* rect,text {
    ...
    <div class="d-flex aad">
        ...
        <div class="mainMargin">
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    <h2 class="ml-0 panelUprText"><?php echo e(translate('Control Panel')); ?></h2>        
                </div>
                <div class="col-md-6">
            ...
            <div class="row mt-3">
                ...
                <div class="col">
                     <div class="zadachiLidi col mb-3">
                        ...
                        <hr>
                        <p><?php echo e(number_format($data['price'],0,'.',' ')); ?></p>
                    </div>
                </div>
...
<?php echo $__env->make('forthebuilder::layouts.forthebuilder', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nurhayat.icstroy.uz/public_html/Modules/ForTheBuilder/Resources/views/index.blade.php ENDPATH**/ ?>
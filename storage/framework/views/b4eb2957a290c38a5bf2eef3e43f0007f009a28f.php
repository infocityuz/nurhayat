            ...
            <div style="max-width: 1394px;">
                ...
                <div class="d-flex justify-content-between">
                    <div class="d-flex">
                        ...
                        <a href="<?php echo e(route('forthebuilder.clients.create', '0')); ?>" class="plus2">+</a>
                    </div>
                            ...
                            <div class="jkMiniData mb-1 hideData">
                                ...
                                <div class="d-flex lidiHrefBigLidiData">
                                    ...
                                    <a href="<?php echo e(route('forthebuilder.clients.show', [$value->client_id, '0', '0'])); ?>" class="dataSdelkaJk <?php echo e($sdelkaClass); ?>">
                                        ...
                                        <?php echo e($value->task_title ? $value->task_title : $defaultAction[$value->deal_type]); ?>
...
<?php echo $__env->make('forthebuilder::layouts.forthebuilder', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nurhayat.icstroy.uz/public_html/Modules/ForTheBuilder/Resources/views/clients/index.blade.php ENDPATH**/ ?>
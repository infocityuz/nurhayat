                ...
                <div class="row m-0 align-items-center">
                    ...
                    <div class="col-4">
                        <div class="ml-auto" id="CurrentDayToday">
                            ...
                            <input type="text" class="ml-2 form-control daterange" value="<?php echo e(date('d.m.Y',strtotime($data['start'])).' - '.date('d.m.Y',strtotime($data['end']))); ?>">
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="profileData">
                                ...
                                <?php if(isset($model->id)): ?>
                                    ...
                                    <?php if(file_exists($sms_avatar)): ?>
                                        <img class="profileImageData"
                                             ...
                                             alt="">
                                    <?php else: ?>
                                        <img class="profileImageData" src="<?php echo e(asset('/backend-assets/forthebuilders/images/X.png')); ?>" alt="">
                                    <?php endif; ?>
                                <?php else: ?>
                                    <img class="profileImageData" src="<?php echo e(asset('/backend-assets/forthebuilders/images/X.png')); ?>" alt="">
                                <?php endif; ?>
                            ...
                            <div style=" margin-top: -40px;">
                                <?php if(isset($model->phone_number)): ?>
                                    <p class="profileOtherData"><?php echo e('+998 '.$model->phone_number); ?></p>
                                <?php else: ?>
                                    <p class="profileOtherData"></p>
                                <?php endif; ?>
                                <p class="profileOtherData"><?php echo e($model->email); ?></p>
                        ...
                        <div class="d-flex">
                            <?php if($user->id == $model->id): ?>
                                <h2 class="panelUprText mx-0"><?php echo e(translate('My stats')); ?></h2>
                            <?php else: ?>
                                <h2 class="panelUprText mx-0"><?php echo e(translate('Stats')); ?></h2>
                            <?php endif; ?>
                        </div>        
                    </div>
                </div>
            ...
            if(data.response_connected_chat_user)
            {
                ...
                if(data.data.length > 0)
                {
                    for(var count = 0; count < data.data.length; count++)
                    {
                        ...
                        {
                            user_image = `<img src="<?php echo e(asset('uploads/user/')); ?>/`+data.data[count].id+`/s_`+data.data[count].user_image+`" width="35" class="rounded-circle" />`;
            ...
            if(data.message)
            {
                ...
                if(data.from_user_id == from_user_id)
                {
                    ...
                    if(data.sender_connection[0].avatar== null)
                    {
                        ...
                        user_image = `<img src="<?php echo e(asset('uploads/user/')); ?>/`+data.from_user_id+`/s_`+data.sender_connection[0].avatar+`" width="35" class="rounded-circle" />`
                    }
                ...
                for(var count = 0; count < data.chat_history.length; count++)
                {
                    if(data.chat_history[count].user_from_id == from_user_id)
                    {
                        ...
                        if(data.sender_connection.avatar== null)
                        {
                            ...
                            user_image = `<img src="<?php echo e(asset('uploads/user/')); ?>/`+data.chat_history[count].user_from_id+`/s_`+data.sender_connection.avatar+`" width="35" class="rounded-circle" />`
                        }
                    ...
                    else
                    {
                        ...
                        if(data.receiver_connection.avatar== null)
                        {
                            ...
                            user_image = `<img src="<?php echo e(asset('uploads/user/')); ?>/`+data.chat_history[count].user_from_id+`/s_`+data.receiver_connection.avatar+`" width="35" class="rounded-circle" />`
                        }
                        html += `
                        &nbsp; `+user_image+`
                                    </div>
                ...
                for(var count = 0; count < data.group_chat_history.length; count++)
                {
                    ...
                    if(data.group_chat_history[count].user_from_id == from_user_id)
                    {
                        ...
                        if(data.group_chat_history[count].avatar== null)
                        {
                            ...
                            user_image = `<img src="<?php echo e(asset('uploads/user/')); ?>/`+data.group_chat_history[count].user_from_id+`/s_`+data.group_chat_history[count].avatar+`" width="35" class="rounded-circle" />`
                        }
...
<?php echo $__env->make('forthebuilder::layouts.forthebuilder', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/user/Desktop/laravel/ikcrm_release/Modules/ForTheBuilder/Resources/views/user/filtr.blade.php ENDPATH**/ ?>
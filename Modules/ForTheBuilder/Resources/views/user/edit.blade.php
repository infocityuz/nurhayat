                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input name="birth_date" id="birth_date"
                                           class="form-control datepicker @error('birth_date') error-data-input is-invalid @enderror"
                                           value="{{$model->birth_date, old('birth_date') }}" type="text">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <label id="phone_number" style="margin-bottom: -35px;z-index: 99;width: 50px;margin-left: 5px;margin-right: -55px;position: sticky;margin-top: 13px;padding-left: 6px;"
                                           for="+998">+998</label>
                                    <input name="phone_number" style="padding-left: 54px; width: 98%;" maxlength="9"

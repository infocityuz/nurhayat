                                        ...
                                        <?php if($status == 'client'): ?>
                                            <?php if($client_id == '0'): ?>
                                                <a class="jkHouseGreen border border-0 btn-filter-flat flat-button flat-button-open-modal"
                                                   href="<?php echo e(route('forthebuilder.clients.create', $val['id'])); ?>"
...
<?php echo $__env->make('forthebuilder::layouts.forthebuilder', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/user/Desktop/laravel/ikcrm_release/Modules/ForTheBuilder/Resources/views/house/show-details.blade.php ENDPATH**/ ?>
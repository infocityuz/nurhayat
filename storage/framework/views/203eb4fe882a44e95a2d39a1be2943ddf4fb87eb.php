...
unset($__errorArgs, $__bag); ?>"
                    ...
                    <div class="d-flex justify-content-between">
                        <div class="sozdatImyaSpsok">
                            <h3 class="sozdatImyaSpisokH3"><?php echo e(translate('Birth date')); ?></h3>
...
unset($__errorArgs, $__bag); ?>"
                                   value="<?php echo e(old('birth_date')); ?>" type="date">
                        </div>
                        <div class="sozdatImyaSpsok">
...
unset($__errorArgs, $__bag); ?>"
                                   value="<?php echo e(old('phone_number')); ?>" type="text">
                        </div>
                    </div>
                    <div class="d-flex justify-content-between">
                        <div>
...
<?php echo $__env->make('forthebuilder::layouts.forthebuilder', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nurhayat.icstroy.uz/public_html/Modules/ForTheBuilder/Resources/views/user/create.blade.php ENDPATH**/ ?>